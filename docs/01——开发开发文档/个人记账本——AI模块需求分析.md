# 个人云端记账本 - AI 模块需求分析说明书 V1.1

| 文档版本 | 修改日期   | 修改人 | 修改内容                           | 备注     |
| :------- | :--------- | :----- | :--------------------------------- | :------- |
| V1.0     | 2026-08-19 | -      | 初稿创建（Grill-Me 决策树产出）    | 待评审   |
| V1.1     | 2026-08-20 | -      | 对齐 V2.1：AI 模型配置变更（Agnes 主 + DeepSeek 备 + ModelScope Embedding）；RAG 暂不使用 Milvus，基于 Embedding 余弦相似度；补充 V2.1 增强场景 | 对齐 V2.1 |
